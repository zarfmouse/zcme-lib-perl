...
sub repeat_until_success {
	...
	if($@ and $@ =~ /(?:Unable to connect)|(?:Connection timed out)|(?:Can\'t connect)|(?:Server closed connection without sending any data back)|(?:Network is unreachable)|(?:read timeout)|(?:502 Proxy Error)|(?:Could not save: there was a problem flushing the hibernate transaction)/) {
